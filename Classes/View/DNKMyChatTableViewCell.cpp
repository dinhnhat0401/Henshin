...
//    this->addChild(bg);
    ...
    myIcon = cocos2d::ui::ImageView::create("res/chara/12/icon.png");
    myIcon->setAnchorPoint(Vec2(0, 0));
...
//    log("%f", this->getBoundingBox().size.height);
    ...
    CCLabelTTF* lbl = CCLabelTTF::create(selection.getAnswer() , "MSGothic", 30);

...
void Timeline::settingOptionMenu()
{
    ...
    auto showOptionButton = MenuItemImage::create("res/talk/btn_close.png",
                                                  ...
                                                  CC_CALLBACK_1(Timeline::showOrHideOptions, this));
...
void Timeline::settingSelectionView(){
    std::string str = "五十嵐信介あろほほほaaaaaaaaaaaa";
    // config options
...
void Timeline::showOrHideOptions(cocos2d::Ref* pSender)
{
    log("show or hide");
    float pos = 0;
